package dev.hctbst.jsonschema2pojo.springframework.data.couchbase;
...
import dev.hctbst.jsonschema2pojo.springframework.data.couchbase.deser.DefaultDefinitionDeserializerModifier;
import dev.hctbst.jsonschema2pojo.springframework.data.couchbase.rules.CouchbaseObjectRule;
import dev.hctbst.jsonschema2pojo.springframework.data.couchbase.rules.CouchbasePropertyRule;
 ...
 * <p>
 * Allows the use of overridden {@link Rule}s to handle Couchbase related elements (e.g. when a schema is marked as
 * document or a property as id).
 *
